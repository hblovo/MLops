...
1. Clone the repository (`git clone https://version.helsinki.fi/mlops/engineering_of_ml_systems.git`). You will be asked to enter a username and password, these are your university credentials. 

1. Install Anaconda from [its official website](https://docs.anaconda.com/free/anaconda/install/index.html).
